...
htmlhelp_basename = "TopoStatsdoc"
...
latex_documents = [
    (master_doc, "TopoStats.tex", "TopoStats Documentation", "Jean", "manual"),
]
...
man_pages = [(master_doc, "topostats", "TopoStats Documentation", [author], 1)]
